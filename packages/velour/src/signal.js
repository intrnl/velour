...
export const is_readable = (source) => {
	return !!(source && source.$$readable);
};
...
export class Scope {
	/**
	 * @param {Scope | boolean} [detached]
	 */
	constructor (detached) {
		let _this = this;

		let parent = detached instanceof Scope ? detached : !detached && eval_scope;
 ...
 * @returns {Readable<T>}
 */
export const readable = (compute) => {
	return new Readable(compute);
};
